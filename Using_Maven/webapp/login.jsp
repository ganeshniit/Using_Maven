...
<title>GiantCart</title>
  ...
  <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
   <br><br><br>
<center><h1 style="color:blue">Welcome!...<br>One Account. All Makes Giant</h1></center>
<style>
body {
...
<input type="button" class="btn btn-success" value="submit"></button>
  &nbsp&nbsp&nbsp&nbsp&nbsp<a href = "forgot">Forgot Password?</a><br>
</form><br>
